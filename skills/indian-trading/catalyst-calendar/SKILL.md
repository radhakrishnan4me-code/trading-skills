...
- Include macro events? (RBI MPC meetings, economic data, regulatory deadlines)
...
- Quarterly earnings date and time (pre-open/post-market)
...
**Macro Events**
- RBI MPC meetings (RBI MPC dates)
- EPFO payroll data/CMIE employment data, CPI, GDP releases
...
- Earnings dates shift — verify against company IR pages and Bloomberg/Screener.in closer to the date
