...
- Quantify variances (e.g., "Revenue beat by ₹1,200 Cr or 3%")
...
```
Source: Q3 2024 Quarterly Results filed November 8, 2024; Company earnings release
        [Hyperlink "Quarterly Results" to: https://www.bseindia.com/corporates/
...
- ✅ Quarterly Results (LODR Reg 33) (with filing date and exchange portal link)
- ✅ Earnings call transcript (with date)
- ✅ Investor presentation/supplemental materials (if available)
- ✅ Consensus estimates source (Bloomberg/Screener.in/Trendlyne with date)
...
• Quarterly Results (Filed November 8, 2024)
  [Hyperlink to: https://www.bseindia.com/corporates/

• Earnings Call Transcript (November 7, 2024)
  [Hyperlink to: https://trendlyne.com/research/...]
...
**Example**: `Titan_Q3_FY25_Earnings_Update.docx`
