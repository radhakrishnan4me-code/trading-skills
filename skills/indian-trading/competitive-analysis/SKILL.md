...
1. Annual Reports / BSE/NSE filings (audited)
...
4. Industry reports (McKinsey, Gartner, CRISIL — market sizing, trends)
5. Data platforms (Screener.in, Trendlyne, Tijori Finance, CMIE Prowess)
6. News (recent developments only; verify against primary sources)
...
- Convert to INR for international comparisons; note the exchange rate and date
...
- **Ratings show the actual.** "●●● ₹12,000 Cr" — not just "●●●."
...
Correct: "Digital payments market is ₹6,000-8,000 Cr in FY25, growing 20-25% CAGR (CRISIL 2025)"
...
| Growth | +26% YoY |
| Gross Margin | 45% |
| Profitability | ₹3,100 Cr Adj. EBITDA |
| Customers | 134K |
| Retention | 92% |
| Market Share | ~15% |
```
...
|---|---|---|---|---|---|---|
| Seg A | ₹20,900 Cr | +26% | 57% | ₹5,400 Cr | +31% | 26% |
| Seg B | ₹11,500 Cr | +31% | 31% | ₹2,100 Cr | +64% | 18% |
| Seg C | ₹4,200 Cr | -2% | 12% | -₹60 Cr | -16% | -1% |
| Total | ₹36,600 Cr | +18% | 100% | ₹5,400 Cr* | - | 15% |
```
...
|---|---|---|---|
| Scale | ●●● ₹12,000 Cr | ●●○ ₹3,750 Cr | ●○○ ₹670 Cr |
| Growth | ●●○ +26% | ●●● +35% | ●●○ +22% |
| Margins | ●●○ 7.5% | ●○○ 3.2% | ●●● 15% |
```
