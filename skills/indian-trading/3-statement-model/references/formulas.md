...
Pre-Tax Income (EBT)
  If EBT > 0:
    ...
    Utilization Limit = MIN(NOL Available, EBT)  (India: full offset allowed, carry-forward up to 8 years for business losses)
...
NOL Utilization Cap:    = NOL Utilized ≤ EBT              (India: full offset allowed; carry-forward limited to 8 years for business losses)
