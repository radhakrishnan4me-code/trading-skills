...
**Earnings & Guidance**
- Any coverage companies reporting overnight or pre-open session?
...
**Market Context**
- Overnight futures / pre-open session moves
...
- Time-stamp your takes — if you're writing at 6am, note that pre-open session may change by open
