...
| **2** | Financial Modeling | Annual Report or financials access | Excel model (6 tabs) |
...
```
User: "Use initiating-coverage, Task 1 for Tata Motors"
Response: ✅ Execute Task 1 immediately
```

**Pattern 2: User asks for "initiation report" or "full pipeline"**
```
User: "Create a coverage initiation report for Tata Motors"
...
```
User: "I want to complete all 5 tasks for Tata Motors"
...
```
"Use initiating-coverage skill, Task 1 for Tata Motors"
"Do Task 2 of initiating-coverage for Tata Motors"
"Run Task 3 for Tata Motors using the initiating-coverage skill"
```

**Completing full report (requires 5 separate requests):**
```
Request 1: "Do Task 1 for Tata Motors" → Complete → Deliver outputs
Request 2: "Do Task 2 for Tata Motors" → Complete → Deliver outputs
Request 3: "Do Task 3 for Tata Motors" → Complete → Deliver outputs
Request 4: "Do Task 4 for Tata Motors" → Complete → Deliver outputs
Request 5: "Do Task 5 for Tata Motors" → Complete → Deliver outputs
```
...
- **Required**: Access to company financial data
  - For public companies: Latest Annual Report from BSE/NSE corporate filings portal
...
- [ ] Have access to Annual Report or financial statements?
...
- **Required**: External market data
  - Historical stock price data (Screener.in/Moneycontrol, Bloomberg, etc.)
...
```
User: "Use initiating-coverage, Task 5 for Tata Motors"

Claude: "Starting Task 5: Report Assembly for Tata Motors
