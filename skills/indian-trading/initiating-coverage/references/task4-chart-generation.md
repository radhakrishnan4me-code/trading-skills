...
- **Required**: External market data
  - Historical stock price data (Screener.in/Moneycontrol, Bloomberg)
...
- [ ] Can access historical stock price data? (Screener.in/Moneycontrol, Bloomberg for chart 01)
...
- Missing external data? → Gather from Screener.in/Moneycontrol, Bloomberg, or similar sources
...
- chart_01: Stock Price Performance → Screener.in/Moneycontrol, Bloomberg, Alpha Vantage
- chart_34: Historical Valuation Multiples → Screener.in/Moneycontrol, Bloomberg (historical P/E, EV/EBITDA)
...
def create_revenue_by_product_chart():
    ...
    ax.set_ylabel('Revenue ( ₹ Cr)', fontsize=12, fontweight='bold')
...
- [ ] Proper units and labels (₹ crores, percentages, etc.)
...
**Example**: `Tata Motors_Charts_2024-10-28.zip`
