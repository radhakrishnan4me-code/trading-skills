...
- **BSE/NSE Filings (for listed companies):**
  - Latest Annual Report: Business description, risk factors, MD&A, financials
  - Recent Quarterly Results: Quarterly updates
  - Annual Report/AGM Notice (AGM Notice): Executive compensation, board composition
  - Stock exchange intimations: Material events, acquisitions, management changes
...
- Competitor websites and BSE/NSE filings
...
- High-level financial metrics (from Annual Report prose, not detailed extraction)
...
2. **Gather BSE/NSE filings (if listed)**
   - Download latest Annual Report from BSE/NSE corporate filings portal
   - Download most recent Quarterly Results
   - Download latest Annual Report/AGM Notice (AGM notice)
   - Note filing dates
...
2. **Research each executive**
   ...
   - Review Annual Report/AGM Notice for background
...
1. **Identify 5-10 competitors**
   ...
   - Check Annual Report for company's own list of competitors

2. **Research each competitor**
   - Visit competitor website
   - Review their BSE/NSE filings (if listed)
...
1. **Define the industry**
   - Industry classification (NIC (National Industrial Classification))
...
Example: `Tata Motors_Research_Document_2024-10-27.md`
