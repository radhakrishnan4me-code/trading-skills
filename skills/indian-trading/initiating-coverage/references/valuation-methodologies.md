...
```
- Risk-Free Rate: 10-year India G-Sec yield
- Beta: Regression of stock returns vs. market (or use comparable beta)
- India Equity Risk Premium: Historical average ~7-8% for India (includes country risk premium)
...
|---------|-----------|------------|-----------|---------|-----------|----------------|---------------|
| Comp A  | ₹X,XXX Cr      | 3.5x       | 12.0x     | 18.0x   | 22.0x     | 15%            | 28%           |
| Comp B  | ₹X,XXX Cr       | 3.0x       | 10.5x     | 16.0x   | 19.0x     | 12%            | 27%           |
| ...     | ...       | ...        | ...       | ...     | ...       | ...            | ...           |
...
**Example Calculation:**
```
Target Company NTM EBITDA = ₹50,000 Cr
Selected EV/EBITDA Multiple = 11.0x
Implied Enterprise Value = ₹50,000 Cr × 11.0x = ₹55,000 Cr

Less: Net Debt = ₹10,000 Cr
Equity Value = ₹45,000 Cr

Shares Outstanding = 100M
Implied Price Per Share = ₹450
```
...
**Sources:**
- BSE/NSE filings (Stock exchange intimation, AGM notices)
- Press releases and investor presentations
- M&A databases (Bloomberg, Ace Equity, CMIE Prowess)
...
|------|--------|----------|------------|------------|-----------|---------|-----------|
| Q1'24 | CompX | BuyerA | ₹50,000 Cr | 4.0x | 14.0x | 35% | Market consolidation |
| Q3'23 | CompY | BuyerB | ₹35,000 Cr | 3.5x | 12.5x | 28% | Strategic fit |
...
**Example Calculation:**
```
Target Company LTM EBITDA = ₹45,000 Cr
Selected EV/EBITDA Multiple = 13.0x (precedent)
vs Trading Comps Multiple = 11.0x

Implied EV (Precedent) = ₹45,000 Cr × 13.0x = ₹58,500 Cr
Implied EV (Trading) = ₹45,000 Cr × 11.0x = ₹49,500 Cr

Implied Control Premium = ₹58,500 Cr / ₹49,500 Cr - 1 = 18%
```
...
|--------|------------------|--------------|-------------|--------|---------------|
| DCF Analysis | ₹52,000 Cr | ₹42,000 Cr | ₹420 | 50% | ₹210 |
| Trading Comps | ₹55,000 Cr | ₹45,000 Cr | ₹450 | 30% | ₹135 |
| Precedent Trans. | ₹58,500 Cr | ₹48,500 Cr | ₹481 | 20% | ₹97 |
| **Weighted Avg** | - | - | **₹440.20** | - | **₹440.20** |
...
Recommendation: BUY with target price of ₹450 (midpoint of base case)
```
